...
#ifndef PLUGIN_VIDEO_HTTP_HPP
#define PLUGIN_VIDEO_HTTP_HPP
...
class HttpVideoPlayer: public Plugin {
public:
    HttpVideoPlayer(int port, int timeout);
...
private:
    std::shared_ptr<Http_Server> wri_;
