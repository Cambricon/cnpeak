...
#include "plugin_infer_batch_parallel.hpp"

InferencerBatchParallel :: InferencerBatchParallel(int server_num, 
                                   ModelType type,
                                   string cali_file,
    ...
    // cali_config_file_ = cali_config_file;
...
string InferencerBatchParallel :: name(){
    return "InferencerBatch";
}

bool InferencerBatchParallel :: init_in_main_thread() {
    ...
    server_ = InferBatchParallelServer::create_infer_batch_server(server_num_, 0, mm_infer_, cur_offline_);
    return true;
}

bool InferencerBatchParallel :: init_in_sub_thread() {
    // init_device();
...
bool InferencerBatchParallel ::callback(TData *&pdata_in, vector<TData *>&pdatas_out) {
    if (pdata_in == nullptr) {
...
// =========================== private function ===============================
// bool InferencerBatchParallel :: init_device() {
//     unsigned dev_num;
...
// void InferencerBatchParallel::init_magicmind_model() {
...
// void InferencerBatchParallel :: load_magicmind_model() {
...
// void InferencerBatchParallel :: init_magicmind_parser(){
...
// void InferencerBatchParallel :: init_magicmind_parser_caffe(){
...
// void InferencerBatchParallel :: init_magicmind_parser_pytorch(){
//     network_ = CreateINetwork();
...
// void InferencerBatchParallel :: init_magicmind_calibration(){
...
// void InferencerBatchParallel ::init_magicmind_build(){
...
// void InferencerBatchParallel :: parse_model_info(){
...
void InferencerBatchParallel ::infer_cur_data(TData*& pdata_in){
...
bool InferencerBatchParallel::get_finished_data(vector<TData*>& pdatas){
    while(true){
        int frame_id;
...
void InferencerBatchParallel :: malloc_mlu_output_cache() {
